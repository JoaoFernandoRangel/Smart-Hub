...
namespace VRWorkshop.XR.Teleport
{
    public class XRTeleportEvents : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            leftHandCancelAction.action.canceled += OnCancelLeftTeleport;
            rightHandCancelAction.action.canceled += OnCancelRightTeleport;

            onActivateTeleport.AddListener(() => Debug.Log("onActivateTeleport"));
            onCancelTeleport.AddListener(() => Debug.Log("onCancelTeleport"));
        }
